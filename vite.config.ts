 ...
 * browser rejects. Chrome-only for now: the "favicon" permission does not exist
 * in Firefox, where AMO flags it as invalid — `faviconUrl()` already falls back
 * to a plain favicon service there, so dropping it costs nothing.
 */
